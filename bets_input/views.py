...
def ordering(request):
    ...
    if race_type == 'race':
        ...
        save_extras_for_race(current_player=current_player, request=request, current_race=current_race, bets=bets)
    ...
    if race_type == 'sprint':
        ...
        save_extras_for_sprint(current_player=current_player, request=request, current_race=current_race, bets=bets)
...
def sort(request):
    ...
    return render(
        ...
        {'bets': bets, 'current_race': current_race, 'current_player': current_player, 'race_type': race_type})
