...
logging.basicConfig(filename='tips_dash/management/scores.log', filemode='w', level=logging.INFO)
...
def score_player(bet : RaceTip, results : Results) -> int:
...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        for player in Player.objects.all(): 
            playersbet = RaceTip.objects.filter(
                race=race,
                player=player
            )
